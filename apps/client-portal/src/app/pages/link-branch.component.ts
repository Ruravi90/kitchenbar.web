...
import { QrScannerComponent } from '@kitchenbar/shared-ui';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ToastModule, ButtonModule, CardModule, DialogModule, ProgressSpinnerModule, QrScannerComponent],
